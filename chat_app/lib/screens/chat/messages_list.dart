    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index){
        return Container(
          ...
          child: Align(
            alignment: (widget.messages[index].username != window.sessionStorage['username']?Alignment.topLeft:Alignment.topRight),
            child: Container(
              constraints: BoxConstraints( maxWidth: 200),
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(20),
                color: (widget.messages[index].username != window.sessionStorage['username']?Colors.purple.shade200:Colors.blue[200]),
              ),
